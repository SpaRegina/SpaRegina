...
Я fullstack-разработчик. Работаю на стыке веб-разработки, AI-решений и автоматизации. Занимаюсь созданием цифровых продуктов end-to-end: от интерфейсов и backend-логики до API, интеграций и AI-компонентов.
